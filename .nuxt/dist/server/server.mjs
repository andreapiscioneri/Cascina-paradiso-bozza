...
import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject, toRef, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, isRef, ref, isReadonly, isShallow, isReactive, toRaw, markRaw, computed, unref, toValue, Fragment, createVNode, Text, watch, defineAsyncComponent, Suspense, nextTick, mergeProps, withCtx, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader, getRequestHeader, setCookie, getCookie, deleteCookie, getRequestURL } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/h3/dist/index.mjs";
import { defu, createDefu } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/defu/dist/defu.mjs";
import { klona } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/klona/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, withoutTrailingSlash, withLeadingSlash, withBase, withTrailingSlash, stringifyQuery, parsePath, parseQuery, isEqual as isEqual$1, withHttps, withoutBase } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/ufo/dist/index.mjs";
import { headSymbol, useHead as useHead$1, useSeoMeta as useSeoMeta$1, resolveUnrefHeadInput } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/@unhead/vue/dist/index.mjs";
import { InferSeoMetaPlugin } from "@unhead/addons";
import { TemplateParamsPlugin } from "unhead/plugins";
import { titleCase, camelCase } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/scule/dist/index.mjs";
import { parse as parse$1 } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/cookie-es/dist/index.mjs";
import destr from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/destr/dist/index.mjs";
import { isEqual } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/ohash/dist/index.mjs";
import { SchemaOrgUnheadPlugin, defineWebSite, defineWebPage } from "@unhead/schema-org/vue";
import { stringify, parse as parse$2 } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/devalue/index.js";
import { toRouteMatcher, createRouter as createRouter$1 } from "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/radix3/dist/index.mjs";
...
const matcher = /* @__PURE__ */ (() => {
  ...
  return (m, p) => {
    ...
    if (p === "/__sitemap__/style.xsl") {
      ...
      r.unshift({ data: $0 });
    } else if (p === "/__sitemap__/it-IT.xml") {
      r.unshift({ data: $0 });
...
const component_45stub2_wQvqphQB8ByXDNz2gX3WoasfJSwxLmxhKS6MoKanM = {};
const _routes = [
  {
    name: "menu___it",
    path: "/menu",
    component: () => import("./_nuxt/menu-xSyGFQ6j.js")
  },
  {
    name: "menu___en",
    path: "/en/menu",
  ...
  },
  {
    name: "index___it",
    path: "/",
    component: () => import("./_nuxt/index-BUHrlKO2.js")
  },
  {
    name: "index___en",
    path: "/en",
  ...
  },
  {
    name: "cookie___it",
    path: "/cookie",
    component: () => import("./_nuxt/cookie-CHMvXEtZ.js")
  },
  {
    name: "cookie___en",
    path: "/en/cookie",
  ...
  },
  {
    name: "storia___it",
    path: "/storia",
    component: () => import("./_nuxt/storia-Bpkh30ae.js")
  },
  {
    name: "storia___en",
    path: "/en/storia",
  ...
  },
  {
    name: "privacy___it",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-Bhbp-dGc.js")
  },
  {
    name: "privacy___en",
    path: "/en/privacy",
  ...
  },
  {
    name: "contatti___it",
    path: "/contatti",
    component: () => import("./_nuxt/contatti-PwEWKuyY.js")
  },
  {
    name: "contatti___en",
    path: "/en/contatti",
  ...
  },
  {
    name: "slug___it",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-D49cN99H.js")
  },
  {
    name: "slug___en",
    path: "/en/:slug(.*)*",
  ...
  {
    name: "prenotazioni___it",
    path: "/prenotazioni",
    component: () => import("./_nuxt/prenotazioni-DraRtMg4.js")
  },
  {
    name: "prenotazioni___en",
    path: "/en/prenotazioni",
    component: () => import("./_nuxt/prenotazioni-DraRtMg4.js")
  },
  {
    name: "posizionamento___it",
    path: "/posizionamento",
    component: () => import("./_nuxt/posizionamento-C2hgit6L.js")
  },
  {
    name: "posizionamento___en",
    path: "/en/posizionamento",
    component: () => import("./_nuxt/posizionamento-C2hgit6L.js")
  },
  {
    name: "trattamento-dati___it",
    path: "/trattamento-dati",
    component: () => import("./_nuxt/trattamento-dati-DOJekNao.js")
  },
  {
    name: "trattamento-dati___en",
    path: "/en/trattamento-dati",
    component: () => import("./_nuxt/trattamento-dati-DOJekNao.js")
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/sitemap.xml",
    component: component_45stub2_wQvqphQB8ByXDNz2gX3WoasfJSwxLmxhKS6MoKanM
  },
  {
    name: __nuxt_page_meta?.name,
    path: "/en/sitemap.xml",
...
const guard_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to) => {
...
const localeLoaders = {
  it: [
    {
      key: "locale_it_46json_5bc2dcf9",
      load: () => import(
        "./_nuxt/it-Bii_EZ8a.js"
        /* webpackChunkName: "locale_it_46json_5bc2dcf9" */
      ),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_6b4be0df",
      load: () => import(
        "./_nuxt/en-CT0SogmV.js"
        /* webpackChunkName: "locale_en_46json_6b4be0df" */
      ),
      cache: true
    }
  ]
...
function createNuxtI18nContext(nuxt, vueI18n, defaultLocale) {
  ...
  const loadMessagesFromServer = async (locale) => {
    ...
    const messages = await $fetch(`${"/_i18n/JWZXWwJs"}/${locale}/messages.json`, { headers });
...
const componentNames = [{ "hash": "SOHaoKfoo4fUkREsCFGw8ewxkl4-XkkHkug2VwYRtFM", "pascalName": "BrandedLogo", "kebabName": "branded-logo", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/BrandedLogo.vue", "category": "community" }, { "hash": "tFoYPh0fXaZR3uXybAqFEOGnQuQsvz-E-Yq-CtrFlIY", "pascalName": "Frame", "kebabName": "frame", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Frame.vue", "category": "community" }, { "hash": "NPQTTXYQ8toXx5OaJ1VlRUUcxy1SNOxg-FoM7C08ZPM", "pascalName": "Nuxt", "kebabName": "nuxt", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Nuxt.vue", "category": "community" }, { "hash": "VAHSTZlVcPHzkozocV1iTnwc4-YttdoOkHsYfoSgDZ4", "pascalName": "NuxtSeo", "kebabName": "nuxt-seo", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/NuxtSeo.vue", "category": "community" }, { "hash": "8CNn4yU043gQFqO-sZNDPz9GKED-h7ahXJ-61c9ThHM", "pascalName": "Pergel", "kebabName": "pergel", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Pergel.vue", "category": "community" }, { "hash": "b-Juo-FXQepo6SOCnA478MTAqbXNZuve6-MzHgTKA7s", "pascalName": "SimpleBlog", "kebabName": "simple-blog", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/SimpleBlog.vue", "category": "community" }, { "hash": "vRUm5ru-64PEHIGsBby6-vCgLBg7iUJfvFKL6VuCXtI", "pascalName": "UnJs", "kebabName": "un-js", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/UnJs.vue", "category": "community" }, { "hash": "hq07GBU-Yd16ICfETt8SfSxfaYj3qBmDAiQkTcv89nw", "pascalName": "Wave", "kebabName": "wave", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/Wave.vue", "category": "community" }, { "hash": "zSwOodBXcjwS1qvFqGBJqitTEEnrvVfwQYkTeIxNpws", "pascalName": "WithEmoji", "kebabName": "with-emoji", "path": "/Users/andreapiscioneri/Repo/Cascina-paradiso-bozza/node_modules/nuxt-og-image/dist/runtime/app/components/Templates/Community/WithEmoji.vue", "category": "community" }];
...
const i18n_EI7LsD1KYQADczz5hrChviGQCdVM8yUkvFEZLJpmnvM = /* @__PURE__ */ defineNuxtPlugin({
  ...
  async setup(_nuxt) {
    ...
    prerenderRoutes(localeCodes.map((locale) => `${"/_i18n/JWZXWwJs"}/${locale}/messages.json`));
...
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-DpHGyEJ1.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative min-h-[100svh] w-full overflow-hidden bg-noir text-cream flex flex-col" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {}, _parent));
      _push(`<div class="absolute inset-0"><img src="https://images.unsplash.com/photo-1514516345957-556ca7d90a29?auto=format&amp;fit=crop&amp;w=2400&amp;q=85" alt="Fuoco acceso" class="w-full h-full object-cover"><div class="absolute inset-0" style="${ssrRenderStyle({ "background": "linear-gradient(180deg, rgba(15,15,15,0.9) 0%, rgba(15,15,15,0.8) 40%, rgba(15,15,15,0.995) 100%)" })}"></div></div><div class="relative z-10 flex-1 flex flex-col items-center justify-center container-x text-center py-10 md:py-14"><p class="eyebrow text-wine mb-6">${ssrInterpolate(unref(statusCode))}</p><h1 class="font-serif font-light text-fluid-6xl leading-tightest tracking-tightest mb-4 max-w-3xl text-balance">${ssrInterpolate(unref(t)("errorPage.titleLine1"))}<br><span class="italic text-wine">${ssrInterpolate(unref(t)("errorPage.titleHighlight"))}</span></h1><p class="text-fluid-base opacity-70 mb-8 max-w-2xl leading-relaxed">${ssrInterpolate(unref(t)("errorPage.descriptionStart"))} <span class="md:whitespace-nowrap">${ssrInterpolate(unref(t)("errorPage.descriptionCta"))}</span></p><button type="button" class="inline-flex items-center justify-center rounded-full border border-white/35 px-6 py-3 text-fluid-sm uppercase tracking-eyebrow transition hover:bg-white/10">${ssrInterpolate(unref(t)("errorPage.backHome"))}</button></div><div class="relative z-10 container-x pb-6 md:pb-8 text-center"><p class="eyebrow opacity-40">${ssrInterpolate(unref(t)("errorPage.footerMark"))}</p></div></div>`);
    };
  }
});
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-izkRaaJu.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
